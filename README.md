...
Web accessibility means that websites, tools, and technologies are designed and developed so that people with disabilities can use them. Web accessibility also benefits people with different devices that have different screen sizes.


2. Talk about 3 different things you can do to ensure your website is accessible. 

Make it have a responsive layout.
